...
export default{
    ...
    data(){
     ...
     async mounted(){
      ...
      this.userId = this.$store.state.profileData.userId;
      this.dataIsHere = true;
      this.skills = this.$store.state.profileData.skills; 
      this.socialLinks = this.$store.state.socialMediaLinks
