                  ...
                  >
                    <div class="row g-4 shadow border-ligth rounded m-3">
                      <div class="col-sm-12 col-md-6 d-flex align-items-center">
                        <router-link :to="`/user?userId=${application.userId?._id}`" class="text-black text-decoration-none d-flex flex-column">
      ...
      <div>
        ...
        <span class="text-truncate">{{ application.candidateId?.jobTitle }}</span>
                      ...
                      <div class=" mb-3">
                        ...
                        <div v-if="application.applicationStatus ==='Submitted'" class="text-warning  fw-bold" >Submitted</div>
                        <div v-if="application.applicationStatus ==='Rejected'" class="text-danger  fw-bold"   >Rejected</div>
                        <div v-if="application.applicationStatus ==='Accepted'" class="text-success  fw-bold"  >Accepted</div>
